...
public class OAuthSecurityConfig {
    ...
    private OAuth2UserService<OAuth2UserRequest, OAuth2User> oauth2UserService() {
        DefaultOAuth2UserService delegete = new DefaultOAuth2UserService();
        return (userRequest) -> {
            ...
            User savedUser = oidcUserPersistence.saveUser(jmixUser);
            savedUser.setAuthorities(getDefaultGrantedAuthorities());
